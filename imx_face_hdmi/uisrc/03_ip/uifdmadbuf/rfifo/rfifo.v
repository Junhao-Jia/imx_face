 ...
 ** File	:	F:/al_data/F201_CA03_PH1A90/03_demo/1207/04_fpga_cs500/uisrc/03_ip/uifdmadbuf/rfifo/rfifo.v
 ** Date	:	2024 12 11
 ** TD version	:	6.0.135568
\************************************************************/
module rfifo #(parameter DATA_WIDTH_W = 256, 
    ...
    always
        @(posedge clkw or 
            posedge wr_rst)
        begin
            if (wr_rst) // the count of data writen to fifo
    ...
    always
        @(posedge clkr or 
            posedge rd_rst)
        begin
            if (rd_rst) // the count of data writen to fifo
    ...
    fifo_cross_domain_addr_process_al_rfifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_rfifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
    ...
    endgenerate
    ram_infer_rfifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_rfifo #(parameter ADDR_WIDTH = 9) (
