module auto_created_cwc3 (  
    ...
    localparam integer CWC_BUS_WIDTH[0:3] = {16,16,1,1};
    localparam integer CWC_BUS_DIN_POS[0:3] = {0,16,32,33};    
    localparam integer CWC_BUS_CTRL_POS[0:3] = {0,52,104,108};    
