 ...
 ** File	:	F:/al_data/F201_CA03_PH1A90/03_demo/1207/04_fpga_cs500/uisrc/03_ip/uifdmadbuf/wfifo/wfifo.v
 ** Date	:	2024 12 10
 ** TD version	:	6.0.135568
\************************************************************/
module wfifo #(parameter DATA_WIDTH_W = 128, 
    ...
    fifo_cross_domain_addr_process_al_wfifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_wfifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
    ...
    endgenerate
    ram_infer_wfifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_wfifo #(parameter ADDR_WIDTH = 9) (
