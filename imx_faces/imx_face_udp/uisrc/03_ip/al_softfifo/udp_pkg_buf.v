 ...
 ** File	:	G:/02_board/02_anlogic/mlk_f201/01_rgmii_loop/al_ip/udp_pkg_buf.v
 ** Date	:	2024 06 06
 ** TD version	:	5.6.88061
\************************************************************/
module udp_pkg_buf #(parameter DATA_WIDTH_W = 8, 
    ...
    fifo_cross_domain_addr_process_al_udp_pkg_buf #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_udp_pkg_buf #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_udp_pkg_buf #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_udp_pkg_buf #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_udp_pkg_buf (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
